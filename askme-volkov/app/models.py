...
class ProfileManager(models.Manager):
    ...
    def create_profile(self, username, email, nickname, password, avatar='uploads/profile.png'):
...
class Profile(models.Model):
    ...
    avatar = models.ImageField(upload_to='uploads', default='uploads/profile.png')
